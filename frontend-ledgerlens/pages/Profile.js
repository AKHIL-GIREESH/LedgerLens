...
<div className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
...
<article className="rounded-3xl border border-gray-100 bg-white p-6 m-4 hover:bg-slate-100">
  ...
  <div className="mt-1 flex gap-1 text-green-600">
    ...
    <p className="flex gap-2 text-xs">
      <span className="text-gray-500">For reading  </span>
    </p>
  </div>
</article>
<article className="rounded-3xl border border-gray-100 bg-white p-6 m-4 hover:bg-slate-100">
...
<article className="rounded-2xl border border-gray-100 bg-white p-6 m-4 hover:bg-slate-100">
  <div className="flex items-center justify-between">
    <div>
      <p className="text-sm text-gray-500">Rewardssss</p>
